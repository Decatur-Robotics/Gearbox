import { BooleanAverage, ComparativePercent, MostCommonValue, NumericalAverage, NumericalTotal, Round, StandardDeviation } from "@/lib/client/StatsMath";
...
test(ComparativePercent.name, () => {
  ...
  expect(ComparativePercent((r) => (r as any).a, (r) => (r as any).b, reports as any)).toBe("25%")
});