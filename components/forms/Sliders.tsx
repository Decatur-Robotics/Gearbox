...
export type SliderProps = {data: FormData, callback: (key: string, value: string | number | boolean) => void};
export default function DefenseSlider(props: SliderProps) {
    ...
    return <div className="w-full text-center">
        ...
        <input onChange={(e) => {props.callback("Defense", keys[e.target.valueAsNumber])}} type="range" min={0} max="2" value={num} className="range range-primary" step="1" />
