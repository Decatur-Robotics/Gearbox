...
export default function Checkbox(props: CheckboxProps) {
    ...
    <input type="checkbox" onChange={()=>{props.callback(props.dataKey, !checked)}} checked={checked} className="w-8 h-8 checkbox checkbox-primary" />
  </label>
}

export function IntakeType(props: RadioProps) {
    return <div className="w-full grid grid-cols-2 grid-rows-3 items-center text-xl">
