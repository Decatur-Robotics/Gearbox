    ...
    <div className="w-full h-full flex flex-col items-center">
      <div className="w-full h-16 bg-base-300 rounded-t-xl flex flex-row font-mono border-4 border-neutral">
        <div className="w-1/2 text-md flex flex-row items-center justify-center text-center">
          <p className="">
            Scored: <span className="block">{props.data.AutoScoredAmp}</span>
          </p>
          <p>
            Missed: <span className="block">{props.data.AutoMissedAmp}</span>
          </p>
        </div>
        <div className="w-1/2 text-md flex flex-row items-center justify-center text-center">
          <p>
            Scored:{" "}
            <span className="block">{props.data.AutoScoredSpeaker}</span>
          </p>
          <p>
            Missed:{" "}
            <span className="block">{props.data.AutoMissedSpeaker}</span>
          </p>
        </div>
      </div>
      <div className="w-full h-2/3 grid grid-cols-2 grid-rows-2">
        ...
        <button
          onClick={() => {
            props.callback(
              "AutoMissedSpeaker",
              props.data.AutoMissedSpeaker + 1
            );
          }}
    ...
    <div className="w-full h-full flex flex-col items-center">
      <div className="w-full h-16 bg-base-300 rounded-t-xl flex flex-row font-mono border-4 border-neutral">
        <div className="w-1/2 text-xs flex flex-row items-center justify-center text-center">
          <p className="">
            Scored: <span className="block">{props.data.TeleopScoredAmp}</span>
          </p>
          <p>
            Missed: <span className="block">{props.data.TeleopMissedAmp}</span>
          </p>
        </div>
        <div className="w-1/2 text-xs flex flex-row items-center justify-center text-center">
          <p className="">
            Scored:{" "}
            <span className="block">{props.data.TeleopScoredSpeaker}</span>
          </p>
          <p>
            Missed:{" "}
            <span className="block">{props.data.TeleopMissedSpeaker}</span>
          </p>
        </div>
        <div className="w-1/2 text-xs flex flex-row items-center justify-center text-center">
          <p>
            Scored: <span className="block">{props.data.TeleopScoredTrap}</span>
          </p>
          <p>
            Missed: <span className="block">{props.data.TeleopMissedTrap}</span>
          </p>
        </div>
      </div>
