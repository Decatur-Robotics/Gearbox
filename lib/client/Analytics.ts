...
function triggerEvent(params: EventParams) {
	if (!ReactGA._hasLoadedGA) console.error("Google Analytics not loaded");

	if (!ReactGA.isInitialized) console.error("Google Analytics not initialized");
...
export namespace Analytics {
	...
	export function teamJoinRequestHandled(
		teamNumber: number,
		league: League,
	...
	export function quantReportSubmitted(
		teamScouted: number,
		teamNumber: number,
		compName: string,
		username: string,
	...
	export function pitReportSubmitted(
		teamScouted: number,
		teamNumber: number,
		compName: string,
		username: string,
	...
	export function subjectiveReportSubmitted(
		teamsWithComments: string[],
		teamNumber: number,
		compName: string,
		username: string,
	) {
