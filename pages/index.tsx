            ...
            <div className="max-w-md flex flex-col items-center">
              ...
              <h1 className="text-5xl font-bold">
                ...
                <span className="text-accent">
                  Gearb
                  <span style={{ userSelect: "none" }} onClick={handleClickO}>
                    {oValue}
                  </span>
                </span>
              </h1>
              <p className="py-6">
                A Fully Customizable, Modular Scouting Platform For FIRST
                Robotics
              </p>
              <a className="btn btn-primary normal-case" href="profile">
                Get {buttonText}
              </a>
            </div>
          </div>
