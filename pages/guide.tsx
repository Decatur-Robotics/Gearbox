		...
		>
			<div className="w-full h-full flex justify-center">
				<div className="w-full md:w-1/2 min-h-screen flex flex-col items-center mt-4 indent-8">
					...
					<p>This quick guide will help you get up and running with Gearbox.</p>
					...
					<p>
						...
						button, then search for your teams number, click the your teams
						name, and Gearbox will generate a new team that is prefilled with
						relevant properties.
					</p>
					<h1 className="text-xl font-semibold mt-2">Joining a Team</h1>
					<p>
						If your team has already joined gearbox you can request to be added
						to it via the join team searchbox. Type your teams number into the
						searchbox then click the team name to send a join request.
					</p>
					...
					<p>
						...
						you can appoint other trusted members of your team to help manage
						your scouting. Managers can toggle who is assigned to scout, manage
						requests to join the team, change the teams settings, and create
					...
					<p>
						...
						make everything scalable and organized. Currently there are only two
						options, the{" "}
						<span className="font-semibold">
							off-season and the current season, Crescendo for us.{" "}
						</span>
						The off-season option is great for getting used to gearbox and
						scouting off-season competitions, but you should use the current
						season, crescendo, for official competitions.
					</p>
					...
					<p>
						...
						matches and particpating teams. Statistics on your scouting
						performance will be displayed at the top of the page along with
						buttons to view your competition stats, pit-stats our slideshow for
						pit display and relevant rankings. When match data is available you
						can click the refresh button which will attempt to pull the latest
						match data from FRC servers and automatically generate matches. Once
						data is available, you can then assign scouters which, will generate
						a set of matches for every selected scouter to cover.
					</p>
					<br></br>
					<p>
						Pitscouting forms are available, which any member of the team can
						access. Pitscouting provides a seperate form you can upload an image
						of the robot and record its capabilities such as drivetrain, climber
						status, and ability to fit under the stage.
					</p>
					...
					<p>
						...
						provided by FIRST, a team manager can manually create matches by
						entering the teams playing in the match and the match number. You
						will need to re-assign scouters after manually creating a match, as
						the match wont have any scouters assigned by default.
					</p>
				</div>
			</div>
		</Container>
