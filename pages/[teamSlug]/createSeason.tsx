                ...
                <div className="flex flex-col lg:flex-row space-y-10 lg:space-x-10 lg:justify-center items-center">
                    ...
                    <div className="card lg:w-1/4 bg-base-100 shadow-xl">
                        ...
                        <div className="card-body">
                            ...
                            <button className={`btn ${existingSeasons?.includes(CurrentSeason.name) ? "btn-disabled disabled" : "btn-primary"} normal-case`} onClick={()=>{createSeason(CurrentSeason)}}>Create</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="card lg:w-1/4 bg-base-100 shadow-xl">
                        <figure>
                            <img  src={"https://www.firstinspires.org/sites/default/files/open-graph-first-logo.png"} alt="Season Logo" />
                        </figure>
                        <div className="card-body">
                            <h2 className="card-title text-2xl">{OffSeason.name}</h2>
                            <p className="text-xl">FIRST Robotics <span className="text-accent">{OffSeason.year} Season</span></p>
                            <div className="card-actions justify-end">
                            <button className={`btn ${existingSeasons?.includes(OffSeason.name) ? "btn-disabled disabled" : "btn-primary"} normal-case`} onClick={()=>{createSeason(OffSeason)}}>Create</button>
                            </div>
                        </div>
                    </div>
                </div>
