...
export default function Stats(props: {reports: Report[], competition: Competition, time: number}) {
  ...
  return <Container requireAuthentication={false} hideMenu={!hide}>
        <div role="tablist" className="tabs tabs-boxed">
          ...
          <a role="tab" className={`tab tab-md `} onClick={resync}>Resync <span className={`ml-2 ${updating ? "animate-spin": ""}`}><FaSync></FaSync></span> <span className="italic text-sm ml-2">(Last Updated: {TimeString(update)})</span></a>
        </div>
